        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          >
            ...
            <ul className="space-y-4 text-slate-600 dark:text-slate-400">
              ...
              <li>
                <Link href="/books" className="hover:text-teal-500 transition-colors">
                  All Books
                </Link>
              </li>
              <li>
        ...
        <div className="pt-8 border-t border-white/10 dark:border-slate-800/30 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-slate-500 dark:text-slate-400">
          ...
          <div className="flex gap-6">
            <motion.a
              ...
              href="https://www.facebook.com/farhan.ahamed.siam.2024"
            ...
            <motion.a
              ...
              target="_blank"
              rel="noopener noreferrer"
              href="https://www.linkedin.com/in/siam-ahamed/"
              className="hover:text-teal-500 transition-colors"
            >
              LinkedIn
            </motion.a>
            <motion.a
              ...
              target="_blank"
              rel="noopener noreferrer"
              href="https://github.com/ahamedsiammia"
              className="hover:text-teal-500 transition-colors"
            >
              GitHub
            </motion.a>
