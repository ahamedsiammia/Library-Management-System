  ...
  const faqs: FAQItem[] = [
    {
      ...
      answer:
        "আপনার একাউন্টে লগইন করে পছন্দের বইটির বিস্তারিত পেজে যান এবং 'Request Book' বাটনে ক্লিক করুন। লাইব্রেরিয়ান রিকোয়েস্ট অ্যাপ্রুভ করলে আপনি লাইব্রেরি কাউন্টার থেকে বই সংগ্রহ করতে পারবেন।",
    },
    {
      question: "একটি বই কতদিনের জন্য কাছে রাখা যাবে?",
      answer:
        "সাধারণত একজন শিক্ষার্থী একসাথে সর্বোচ্চ ১৪ দিনের জন্য বই নিজের কাছে রাখতে পারবে। প্রয়োজনে মেয়াদ শেষ হওয়ার আগেই অনলাইন থেকে রিনিউ করার সুযোগ রয়েছে।",
    },
    {
      question: "ই-বুক কি ডাউনলোড করে অফলাইনে পড়া যাবে?",
      answer:
        "হ্যাঁ, আমাদের ডিজিটাল প্ল্যাটফর্মে যে বইগুলোর 'PDF/Digital Copy' দেওয়া আছে, সেগুলো আপনি সরাসরি অ্যাপ বা ওয়েবসাইট থেকে ডাউনলোড করে যেকোনো সময় পড়তে পারবেন।",
    },
    {
      question: "বই জমা দিতে দেরি হলে কি কোনো ফাইন বা জরিমানা আছে?",
      answer:
        "মেয়াদ পার হয়ে গেলে প্রতিদিনের জন্য নির্দিষ্ট হারে লেট ফি যুক্ত হবে। তাই মেয়াদ শেষ হওয়ার আগেই অনলাইন থেকে বইটি রিনিউ করুন অথবা সরাসরি লাইব্রেরিতে জমা দিন।",
    },
  ];
